      ...
      <form onSubmit={onSearch}>
        <div style={{ display: 'flex', justifyContent: 'space-around' }}>
          <div>
            ...
            <input class="form-control" type="text" placeholder="e.g chinese" key="cuisine" name="cuisine" onChange={({ target }) => setInputs(state => ({ ...state, cuisine: target.value }))} value={inputs.cuisine} />
          </div>
